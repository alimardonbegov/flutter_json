...
/// docx abstract templater for different pdf templater (create generator for each tpl page manually)
abstract class PdfTemplater extends Templater {
  final Map<String, String> clientMap;

  PdfTemplater({required super.ds, required this.clientMap});
...
class JprTemplater extends PdfTemplater {
  JprTemplater({required super.ds, required super.clientMap});
